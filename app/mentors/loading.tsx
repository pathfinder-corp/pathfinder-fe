          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="flex items-center justify-center gap-16 mb-14">
              <div className="text-center">
                <Skeleton className="h-12 w-24 mx-auto mb-1 bg-neutral-800" />
                <Skeleton className="h-5 w-28 mx-auto bg-neutral-800" />
              </div>
              <div className="h-10 w-px bg-neutral-800" />
              <div className="text-center">
                <Skeleton className="h-12 w-20 mx-auto mb-1 bg-neutral-800" />
                <Skeleton className="h-5 w-24 mx-auto bg-neutral-800" />
              </div>
              <div className="h-10 w-px bg-neutral-800" />
              <div className="text-center">
                <Skeleton className="h-12 w-28 mx-auto mb-1 bg-neutral-800" />
                <Skeleton className="h-5 w-36 mx-auto bg-neutral-800" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-6">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex items-center gap-3">
                <Skeleton className="h-16 w-[180px] bg-neutral-800 rounded-lg" />
                <Skeleton className="h-16 w-[200px] bg-neutral-800 rounded-lg" />
                <Skeleton className="h-16 w-36 bg-neutral-800 rounded-lg" />
              </div>
            </div>
          </div>
        </section>
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden">
                ...
                <div className="p-6 pt-14">
                  <Skeleton className="h-8 w-44 mb-2 bg-neutral-800" />
                  <Skeleton className="h-6 w-60 mb-4 bg-neutral-800" />
                  <Skeleton className="h-14 w-full mb-5 bg-neutral-800" />
